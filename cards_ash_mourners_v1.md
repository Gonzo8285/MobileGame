...
_Next backlog hop: ~~C4 — Coven of the Black Mire full pool (~40 cards)~~ **DONE 2026-05-01** — Coven pool authored (cards_coven_v1.md, 40 cards C11–C40 + retained C1–C10). C6 Mother Quag stays as a single dual-archetype card per Paul's 2026-05-01 lock; new cards Witch of the Bound Coin, Brood-Mother of the Mire, Ferryman of the Drowned Coin, Drowning of the Demon-Coin all authored. As of 2026-05-26, all 5 factions have full 40-card v1 pools authored. Next content workstream: TBD by Paul — candidates are aura-system keyword design (`keywords/aura_v0.md` — unblocks W42.E1 + Banner-buff + Penance triggers), or M41/W41/W42 engine-wiring heartbeats per the TODO blocks in `game/src/runtime/turn_engine.gd`._
