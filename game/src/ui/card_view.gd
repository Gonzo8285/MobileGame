...
func _faction_tint(f: GFEnums.Faction) -> Color:
	match f:
		...
		GFEnums.Faction.WITHERED_COURT: return Color(0.22, 0.18, 0.30, 1.0)
		GFEnums.Faction.HOLLOW_PACT:    return Color(0.14, 0.32, 0.22, 1.0)
		GFEnums.Faction.FERRUM_HOST:    return Color(0.36, 0.30, 0.18, 1.0)
		GFEnums.Faction.SABLE_WILDS:    return Color(0.24, 0.18, 0.12, 1.0)
