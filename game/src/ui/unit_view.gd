...
func _faction_colour(f: int) -> Color:
	match f:
		...
		GFEnums.Faction.WITHERED_COURT: return Color(0.35, 0.25, 0.50)
		GFEnums.Faction.HOLLOW_PACT:    return Color(0.18, 0.50, 0.30)
		GFEnums.Faction.FERRUM_HOST:    return Color(0.50, 0.42, 0.18)
		GFEnums.Faction.SABLE_WILDS:    return Color(0.45, 0.30, 0.15)
