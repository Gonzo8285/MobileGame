...
func _faction_colour(faction: int) -> Color:
	match faction:
		...
		GFEnums.Faction.WITHERED_COURT: return Color(0.20, 0.10, 0.25)
		GFEnums.Faction.HOLLOW_PACT:    return Color(0.10, 0.20, 0.15)
		GFEnums.Faction.FERRUM_HOST:    return Color(0.18, 0.18, 0.20)
		GFEnums.Faction.SABLE_WILDS:    return Color(0.15, 0.20, 0.10)
