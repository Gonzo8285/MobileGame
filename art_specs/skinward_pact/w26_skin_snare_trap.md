# Per-card art spec — Skin-Snare Trap
...
```
wire-and-bone snare laid across cinderwood path, antler-bone spike trigger, hide cloak shred bait, smoke-trailing residue, bark-brown loam, mismatched moonlight, druidic ambush
```
...
- **seed:** 82626
- **rationale:** card_id digits → 26, formula 80000 + 101 × 26 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w26_skin_snare_trap.png`
- **iterations_path:** `art_iterations/W26_skin_snare_trap/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed82626_v1 | first pass — accept / iterate |
