# Per-card art spec — Hide-Sworn Bonebinder
...
- **card_id:** W18
- **display_name:** Hide-Sworn Bonebinder
...
```
ritual binder weaving sinew through bone, antler-crown sprouting through skull, hide cloak layered, smoke-trailing fingers tying knots, mismatched eyes, bark-brown thread, cinderwood altar
```
...
- **seed:** 81818
- **rationale:** card_id digits → 18, formula 80000 + 101 × 18 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w18_hide_sworn_bonebinder.png`
- **iterations_path:** `art_iterations/W18_hide_sworn_bonebinder/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed81818_v1 | first pass — accept / iterate |
