# Per-card art spec — Pelt-Gathered Hunter
...
- **card_id:** W1
- **display_name:** Pelt-Gathered Hunter
...
```
wilds hunter in patchwork pelts, layered hide cloak, antler-tipped spear, mismatched eyes scanning the underbrush, bone fetish at belt, bark-brown war-paint, cinderwood-grove undergrowth
```
...
- **seed:** 80101
- **rationale:** card_id digits → 1, formula 80000 + 101 × 1 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w1_pelt_gathered_hunter.png`
- **iterations_path:** `art_iterations/W1_pelt_gathered_hunter/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed80101_v1 | first pass — accept / iterate |
