# Per-card art spec — Wolf-Pelt Sigil
...
```
Wolf-Pelt Sigil relic stretched over antler-bone frame, hide cloak banner draped, smoke-trailing braziers, bark-brown ash, mismatched moonlight, cinderwood-grove vault, druidic phyrexian undertone
```
...
- **seed:** 84040
- **rationale:** card_id digits → 40, formula 80000 + 101 × 40 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w40_wolf_pelt_sigil.png`
- **iterations_path:** `art_iterations/W40_wolf_pelt_sigil/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed84040_v1 | first pass — accept / iterate |
