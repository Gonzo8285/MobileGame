# Per-card art spec — Den-Mother of the Cinderwood
...
- **card_id:** W42
- **display_name:** Den-Mother of the Cinderwood
- **faction:** skinward_pact
- **card_type:** UNIT
- **rarity:** UNCOMMON
- **role:** spine (Phase 2.13 N4 — E3 Beast-Summon curve-topping anchor)
...
```
Den-Mother of the Cinderwood — grizzled she-druid kneeling among three wolf-cubs, hide cloak heavy with bone-tokens, antler-circlet, soot-blackened fingers, ember-eyed wolves at heel, cinderwood-burrow background
```
...
- **seed:** 84242
- **rationale:** card_id digits → 42, formula 80000 + 101 × 42 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w42_den_mother_of_the_cinderwood.png`
- **iterations_path:** `art_iterations/W42_den_mother_of_the_cinderwood/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-26 | spec_authored | Phase 2.13 N4 — art spec authored by Controller. Card .tres at `game/data/cards/skinward_pact/W42.tres`. NOTE collision risk: existing W34 "Den-Mother" art spec already exists (5c C, generic den-mother). This W42 is a DIFFERENT, larger, more iconic den-mother (4c U Phase 2.13 spine). Composition signal: W34 broods alone; W42 surrounded by cubs at heel (the lane-aura mechanic made visible). Iteration must keep these two visually distinct. |
...
- [ ] Composition — focal figure dominates with cubs as supporting motif (cubs visible at thumbnail to signal lane-aura mechanic)
- [ ] **Visually distinct from W34 Den-Mother** (W34 broods alone; W42 surrounded by cubs at heel)
