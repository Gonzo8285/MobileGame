# Per-card art spec — Whelping Burrow
...
```
wolf-whelping burrow under cinderwood roots, antler-bone frame, hide cloak nest, smoke-trailing breath rising from pups within, bark-brown moss, mismatched moonlight, druidic phyrexian undertone
```
...
- **seed:** 83838
- **rationale:** card_id digits → 38, formula 80000 + 101 × 38 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w38_whelping_burrow.png`
- **iterations_path:** `art_iterations/W38_whelping_burrow/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed83838_v1 | first pass — accept / iterate |
