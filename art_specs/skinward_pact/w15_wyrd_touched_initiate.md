# Per-card art spec — Wyrd-Touched Initiate
...
- **card_id:** W15
- **display_name:** Wyrd-Touched Initiate
...
```
young initiate mid-transformation, antler-crown emerging through bone, hide cloak slipping away, smoke-trailing fingers, mismatched eyes flickering, bark-brown body-paint, cinderwood-grove rite
```
...
- **seed:** 81515
- **rationale:** card_id digits → 15, formula 80000 + 101 × 15 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w15_wyrd_touched_initiate.png`
- **iterations_path:** `art_iterations/W15_wyrd_touched_initiate/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed81515_v1 | first pass — accept / iterate |
