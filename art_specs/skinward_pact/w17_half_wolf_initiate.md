# Per-card art spec — Half-Wolf Initiate
...
- **card_id:** W17
- **display_name:** Half-Wolf Initiate
...
```
half-wolf initiate mid-shift, snout pushing through human face, antler-bone fusion, hide cloak torn, smoke-trailing claws, mismatched eyes glowing, bark-brown ritual fur
```
...
- **seed:** 81717
- **rationale:** card_id digits → 17, formula 80000 + 101 × 17 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w17_half_wolf_initiate.png`
- **iterations_path:** `art_iterations/W17_half_wolf_initiate/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed81717_v1 | first pass — accept / iterate |
