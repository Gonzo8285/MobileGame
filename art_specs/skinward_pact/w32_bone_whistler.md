# Per-card art spec — Bone-Whistler
...
```
ritual bone-whistler raising carved tibia to lips, antler-crown nub, hide cloak hung with whistles, smoke-trailing breath, mismatched eyes, bark-brown body-paint, cinderwood-grove den behind
```
...
- **seed:** 83232
- **rationale:** card_id digits → 32, formula 80000 + 101 × 32 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w32_bone_whistler.png`
- **iterations_path:** `art_iterations/W32_bone_whistler/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed83232_v1 | first pass — accept / iterate |
