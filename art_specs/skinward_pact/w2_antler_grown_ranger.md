# Per-card art spec — Antler-Grown Ranger
...
- **card_id:** W2
- **display_name:** Antler-Grown Ranger
...
```
lone-stalking ranger with antler-crown sprouting through scalp, dark hide cloak, longbow of cinderwood, smoke-trailing breath, bark-brown leathers, mismatched eyes, solitary forest-trail backdrop
```
...
- **seed:** 80202
- **rationale:** card_id digits → 2, formula 80000 + 101 × 2 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w2_antler_grown_ranger.png`
- **iterations_path:** `art_iterations/W2_antler_grown_ranger/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed80202_v1 | first pass — accept / iterate |
