# Per-card art spec — Cub of the Sundered Tree
...
- **card_id:** W14
- **display_name:** Cub of the Sundered Tree
...
```
small antlered cub gnawing on a sundered cinderwood root, half-grown antler-crown, hide cloak rag swaddling, mismatched eyes wide, bark-brown fur, druidic phyrexian undertone scars
```
...
- **seed:** 81414
- **rationale:** card_id digits → 14, formula 80000 + 101 × 14 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w14_cub_of_the_sundered_tree.png`
- **iterations_path:** `art_iterations/W14_cub_of_the_sundered_tree/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed81414_v1 | first pass — accept / iterate |
