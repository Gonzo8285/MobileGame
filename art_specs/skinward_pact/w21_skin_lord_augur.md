# Per-card art spec — Skin-Lord Augur
...
```
skin-lord augur reading entrails on antler-bone altar, antler-crown sprouting, hide cloak layered, smoke-trailing fingers, mismatched eyes white with vision, bark-brown stains, cinderwood-grove vault
```
...
- **seed:** 82121
- **rationale:** card_id digits → 21, formula 80000 + 101 × 21 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w21_skin_lord_augur.png`
- **iterations_path:** `art_iterations/W21_skin_lord_augur/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed82121_v1 | first pass — accept / iterate |
