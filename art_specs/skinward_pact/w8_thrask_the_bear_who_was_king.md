# Per-card art spec — Thrask, the Bear-Who-Was-King
...
- **card_id:** W8
- **display_name:** Thrask, the Bear-Who-Was-King
...
```
monstrous bear-king Thrask, crowned with antler-bone, hide cloak of his murdered subjects, mismatched eyes glowing pyre-red, smoke-trailing claws, bark-brown ruin, cinderwood-throne behind
```
...
- **seed:** 80808
- **rationale:** card_id digits → 8, formula 80000 + 101 × 8 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w8_thrask_the_bear_who_was_king.png`
- **iterations_path:** `art_iterations/W8_thrask_the_bear_who_was_king/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed80808_v1 | first pass — accept / iterate |
