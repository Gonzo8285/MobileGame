# Per-card art spec — Skin-Walker Apprentice
...
- **card_id:** W16
- **display_name:** Skin-Walker Apprentice
...
```
skin-walker apprentice in shifting hide cloak, antler-bud crown, smoke-trailing wrists, mismatched eyes split human-and-beast, bark-brown ritual paint, druidic phyrexian undertone
```
...
- **seed:** 81616
- **rationale:** card_id digits → 16, formula 80000 + 101 × 16 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w16_skin_walker_apprentice.png`
- **iterations_path:** `art_iterations/W16_skin_walker_apprentice/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed81616_v1 | first pass — accept / iterate |
