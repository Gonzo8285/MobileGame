...
```
swift pack-runner in close hide-cloak, antler-bud crown, smoke-trailing heels, mismatched eyes scanning the lane, bark-brown leather, cinderwood-grove path, druidic phyrexian undertone scars
```
...
- **seed:** 83030
- **rationale:** card_id digits → 30, formula 80000 + 101 × 30 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w30_pack_runner.png`
- **iterations_path:** `art_iterations/W30_pack_runner/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed83030_v1 | first pass — accept / iterate |
