# Per-card art spec — Pack-Sworn Houndmaster
...
- **card_id:** W33
- **display_name:** Pack-Sworn Houndmaster
...
```
Pack-Sworn Houndmaster surrounded by pelt-fetish, antler-crown of stag-bone, hide cloak hung with hound-skulls, smoke-trailing fingers, mismatched eyes, bark-brown leather, cinderwood-grove kennel
```
...
- **seed:** 83333
- **rationale:** card_id digits → 33, formula 80000 + 101 × 33 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w33_pack_sworn_houndmaster.png`
- **iterations_path:** `art_iterations/W33_pack_sworn_houndmaster/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed83333_v1 | first pass — accept / iterate |
