# Per-card art spec — Bear-Skin Hierophant
...
- **card_id:** W4
- **display_name:** Bear-Skin Hierophant
...
```
shamanic hierophant draped in immense bear pelt and skull-helm, antler-crown sprouting, hide-cloaked, mismatched eyes glowing, bark-brown ritual paint, cinderwood-grove altar behind
```
...
- **seed:** 80404
- **rationale:** card_id digits → 4, formula 80000 + 101 × 4 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w4_bear_skin_hierophant.png`
- **iterations_path:** `art_iterations/W4_bear_skin_hierophant/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed80404_v1 | first pass — accept / iterate |
