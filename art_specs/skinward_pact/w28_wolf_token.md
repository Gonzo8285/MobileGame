...
```
lean Wilds wolf-token, antler-grafted skull, hide-cloak ruff at neck, smoke-trailing breath, mismatched eyes glowing, bark-brown fur, cinderwood-grove undergrowth, druidic phyrexian undertone
```
...
- **seed:** 82828
- **rationale:** card_id digits → 28, formula 80000 + 101 × 28 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w28_wolf_token.png`
- **iterations_path:** `art_iterations/W28_wolf_token/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed82828_v1 | first pass — accept / iterate |
