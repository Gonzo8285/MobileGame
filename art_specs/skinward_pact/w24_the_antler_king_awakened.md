# Per-card art spec — The Antler-King Awakened
...
- **card_id:** W24
- **display_name:** The Antler-King Awakened
...
```
the Antler-King reborn from cinderwood roots, vast antler-crown breaking through bone, hide cloak shed, smoke-trailing roar, mismatched glowing eyes, bark-brown dust storm, doomed grandeur
```
...
- **seed:** 82424
- **rationale:** card_id digits → 24, formula 80000 + 101 × 24 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w24_the_antler_king_awakened.png`
- **iterations_path:** `art_iterations/W24_the_antler_king_awakened/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed82424_v1 | first pass — accept / iterate |
