# Per-card art spec — Antler-Crown Sigil
...
- **card_id:** W39
- **display_name:** Antler-Crown Sigil
...
```
Antler-Crown Sigil relic floating above cinderwood altar, vast antler-bone crown, hide cloak pelts arrayed, smoke-trailing offerings, bark-brown ash circle, mismatched moonlight, druidic phyrexian undertone
```
...
- **seed:** 83939
- **rationale:** card_id digits → 39, formula 80000 + 101 × 39 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w39_antler_crown_sigil.png`
- **iterations_path:** `art_iterations/W39_antler_crown_sigil/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed83939_v1 | first pass — accept / iterate |
