...
```
echoing howl shaking cinderwood-grove canopy, smoke-trailing breath rising from hide-cloaked figure, antler-crown silhouette, bark-brown bark, mismatched moonlight, druidic ritual spirit
```
...
- **seed:** 81111
- **rationale:** card_id digits → 11, formula 80000 + 101 × 11 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w11_wild_howl.png`
- **iterations_path:** `art_iterations/W11_wild_howl/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed81111_v1 | first pass — accept / iterate |
