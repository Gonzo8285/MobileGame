...
```
ritual roar tearing through cinderwood grove, smoke-trailing breath erupting from a hidden Wilds, antler-crown shadow on bark, mismatched moonlight, bark-brown scattered leaves
```
...
- **seed:** 80909
- **rationale:** card_id digits → 9, formula 80000 + 101 × 9 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w9_cinder_roar.png`
- **iterations_path:** `art_iterations/W9_cinder_roar/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed80909_v1 | first pass — accept / iterate |
