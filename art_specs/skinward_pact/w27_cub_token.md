...
```
small Wilds cub-token, half-formed antler-bud crown, ragged hide cloak, mismatched eyes, smoke-trailing breath, bark-brown fur, cinderwood-grove backdrop, druidic phyrexian undertone scuff
```
...
- **seed:** 82727
- **rationale:** card_id digits → 27, formula 80000 + 101 × 27 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w27_cub_token.png`
- **iterations_path:** `art_iterations/W27_cub_token/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed82727_v1 | first pass — accept / iterate |
