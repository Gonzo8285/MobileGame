...
```
wyrd-binding glyph carved into cinderwood bark, antler-bone runes glowing, smoke-trailing residue rising, hide cloak strip pinned, bark-brown moss curl, druidic phyrexian undertone
```
...
- **seed:** 82222
- **rationale:** card_id digits → 22, formula 80000 + 101 × 22 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w22_wyrd_bind.png`
- **iterations_path:** `art_iterations/W22_wyrd_bind/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed82222_v1 | first pass — accept / iterate |
