# Per-card art spec — Stag-Crowned Witness
...
- **card_id:** W20
- **display_name:** Stag-Crowned Witness
...
```
tall stag-crowned witness, broad antler-crown towering, hide cloak hung with bone-fetishes, smoke-trailing breath, mismatched eyes calmly observing, bark-brown shrouds, cinderwood-grove dais
```
...
- **seed:** 82020
- **rationale:** card_id digits → 20, formula 80000 + 101 × 20 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w20_stag_crowned_witness.png`
- **iterations_path:** `art_iterations/W20_stag_crowned_witness/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed82020_v1 | first pass — accept / iterate |
