# Per-card art spec — Old-Wyrm Whelp
...
```
small wyrm-blooded whelp, scaled hide cloak fused into skin, half-formed antler nubs, smoke-trailing nostrils, mismatched eyes, bark-brown moss patina, cinderwood-grove burrow
```
...
- **seed:** 80505
- **rationale:** card_id digits → 5, formula 80000 + 101 × 5 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w5_old_wyrm_whelp.png`
- **iterations_path:** `art_iterations/W5_old_wyrm_whelp/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed80505_v1 | first pass — accept / iterate |
