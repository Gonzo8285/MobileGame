...
```
Den-Mother brooding over cinderwood burrow, vast antler-crown, hide cloak heavy with cub-pelts, smoke-trailing fingers, mismatched eyes, bark-brown fur, cinderwood-grove den
```
...
- **seed:** 83434
- **rationale:** card_id digits → 34, formula 80000 + 101 × 34 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w34_den_mother.png`
- **iterations_path:** `art_iterations/W34_den_mother/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed83434_v1 | first pass — accept / iterate |
