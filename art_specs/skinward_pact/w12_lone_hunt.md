...
```
solitary hunter's mark in cinderwood underbrush, single antler-print pressed into bark-brown moss, smoke-trailing footprint, hide cloak shred snagged on briar, mismatched moonlight
```
...
- **seed:** 81212
- **rationale:** card_id digits → 12, formula 80000 + 101 × 12 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w12_lone_hunt.png`
- **iterations_path:** `art_iterations/W12_lone_hunt/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed81212_v1 | first pass — accept / iterate |
