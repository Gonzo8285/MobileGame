# Per-card art spec — Hunter's Snare
...
```
concealed hunter's snare across cinderwood path, antler-bone trigger, hide cloak strip bait, smoke-trailing residue, bark-brown loam, mismatched moonlight, cub-token shadow
```
...
- **seed:** 83737
- **rationale:** card_id digits → 37, formula 80000 + 101 × 37 (Skinward Pact faction tag = 8)
...
- **output_path:** `art/skinward_pact/w37_hunters_snare.png`
- **iterations_path:** `art_iterations/W37_hunters_snare/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed83737_v1 | first pass — accept / iterate |
