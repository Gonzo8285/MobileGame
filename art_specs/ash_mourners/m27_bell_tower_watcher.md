# Per-card art spec — Bell-Tower Watcher
...
- **card_id:** M27
- **display_name:** Bell-Tower Watcher
...
```
hooded watcher leaning out of a bell-tower window, dusk-purple cloak whipped by wind, ink-stained fingers gripping iron grille, distant gothic spire, raven flock circling
```
...
- **seed:** 52727
- **rationale:** card_id digits → 27, formula 50000 + 101 × 27 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m27_bell_tower_watcher.png`
- **iterations_path:** `art_iterations/M27_bell_tower_watcher/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed52727_v1 | first pass — accept / iterate |
