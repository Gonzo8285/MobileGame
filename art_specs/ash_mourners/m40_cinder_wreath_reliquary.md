# Per-card art spec — Cinder-Wreath Reliquary
...
- **card_id:** M40
- **display_name:** Cinder-Wreath Reliquary
...
```
iron-bound reliquary box with a dusk-purple cinder-wreath set into the lid, raven-quill insignia, ink-stained inscription, gothic-cathedral altar shelf, candle burning low
```
...
- **seed:** 54040
- **rationale:** card_id digits → 40, formula 50000 + 101 × 40 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m40_cinder_wreath_reliquary.png`
- **iterations_path:** `art_iterations/M40_cinder_wreath_reliquary/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed54040_v1 | first pass — accept / iterate |
