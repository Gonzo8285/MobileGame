...
```
old hooded tender feeding cinders into a stone pyre-bowl, ash drifting upward, court-mourning robe singed, raven-quill at belt, gothic vault columns flanking him
```
...
- **seed:** 51717
- **rationale:** card_id digits → 17, formula 50000 + 101 × 17 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m17_pyre_tender.png`
- **iterations_path:** `art_iterations/M17_pyre_tender/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed51717_v1 | first pass — accept / iterate |
