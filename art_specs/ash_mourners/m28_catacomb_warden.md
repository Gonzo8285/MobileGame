# Per-card art spec — Catacomb Warden
...
```
gaunt warden in heavy court-mourning livery, holding iron key-ring of crypt locks, raven-quill at belt, dusk-purple stole, vault columns lit by single torch behind
```
...
- **seed:** 52828
- **rationale:** card_id digits → 28, formula 50000 + 101 × 28 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m28_catacomb_warden.png`
- **iterations_path:** `art_iterations/M28_catacomb_warden/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed52828_v1 | first pass — accept / iterate |
