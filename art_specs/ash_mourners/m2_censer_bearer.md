# Per-card art spec — Censer-Bearer
...
```
hooded mourner swinging a heavy iron censer on chain, plumes of incense smothering the air, dusk-purple sash, gothic vault arches behind, ink-stained hands
```
...
- **seed:** 50202
- **rationale:** card_id digits → 2, formula 50000 + 101 × 2 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m2_censer_bearer.png`
- **iterations_path:** `art_iterations/M2_censer_bearer/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed50202_v1 | first pass — accept / iterate |
