# Per-card art spec — Necrologist of the Catacombs
...
- **card_id:** M12
- **display_name:** Necrologist of the Catacombs
...
```
scholar of the dead in court-shroud robes, writing every fallen name in a vast ink-bound ledger, raven-quill ablaze with dusk-purple ink, hood low, no-shadow silhouette
```
...
- **seed:** 51212
- **rationale:** card_id digits → 12, formula 50000 + 101 × 12 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m12_necrologist_of_the_catacombs.png`
- **iterations_path:** `art_iterations/M12_necrologist_of_the_catacombs/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed51212_v1 | first pass — accept / iterate |
