# Per-card art spec — Cinder Bloom
...
```
dusk-purple flame blooming through a pile of grey ash, ink-stained pages curling, gothic catacomb floor, drifting cinder-petals in the air, no figures present
```
...
- **seed:** 53232
- **rationale:** card_id digits → 32, formula 50000 + 101 × 32 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m32_cinder_bloom.png`
- **iterations_path:** `art_iterations/M32_cinder_bloom/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed53232_v1 | first pass — accept / iterate |
