# Per-card art spec — The Drowning Hush
...
- **card_id:** M34
- **display_name:** The Drowning Hush
...
```
black-water flood spilling silently across a cathedral floor, candles drowned mid-flame, court-mourning livery floating, raven feathers half-submerged, gothic vault haze
```
...
- **seed:** 53434
- **rationale:** card_id digits → 34, formula 50000 + 101 × 34 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m34_the_drowning_hush.png`
- **iterations_path:** `art_iterations/M34_the_drowning_hush/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed53434_v1 | first pass — accept / iterate |
