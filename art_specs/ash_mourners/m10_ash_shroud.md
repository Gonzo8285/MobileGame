...
```
great court-shroud descending from gothic vault rafters, dusk-purple cloth blanketing the lane, raven-quill sigils stitched across it, no-shadow mourners receding
```
...
- **seed:** 51010
- **rationale:** card_id digits → 10, formula 50000 + 101 × 10 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m10_ash_shroud.png`
- **iterations_path:** `art_iterations/M10_ash_shroud/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed51010_v1 | first pass — accept / iterate |
