# Per-card art spec — Black-Bell Sister
...
- **card_id:** M29
- **display_name:** Black-Bell Sister
...
```
austere sister in black-bell habit, court-mourning veil, hand resting on iron handbell, ink-stained palms, gothic-cathedral arch behind her, dusk-purple shadow
```
...
- **seed:** 52929
- **rationale:** card_id digits → 29, formula 50000 + 101 × 29 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m29_black_bell_sister.png`
- **iterations_path:** `art_iterations/M29_black_bell_sister/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed52929_v1 | first pass — accept / iterate |
