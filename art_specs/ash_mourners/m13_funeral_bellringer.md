# Per-card art spec — Funeral Bellringer
...
- **card_id:** M13
- **display_name:** Funeral Bellringer
...
```
broad-shouldered ringer hauling a great iron bell-rope, hooded in court-mourning, ink-stained gloves, raven-quill on chest sash, catacomb-bell tower behind in dusk-purple haze
```
...
- **seed:** 51313
- **rationale:** card_id digits → 13, formula 50000 + 101 × 13 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m13_funeral_bellringer.png`
- **iterations_path:** `art_iterations/M13_funeral_bellringer/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed51313_v1 | first pass — accept / iterate |
