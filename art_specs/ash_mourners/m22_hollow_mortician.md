# Per-card art spec — Hollow Mortician
...
```
tall gaunt embalmer in stained court-mourning livery, ink-soaked apron, holding a long preparation needle, no-shadow figure, lit by single candle, dusk-purple shadow
```
...
- **seed:** 52222
- **rationale:** card_id digits → 22, formula 50000 + 101 × 22 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m22_hollow_mortician.png`
- **iterations_path:** `art_iterations/M22_hollow_mortician/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed52222_v1 | first pass — accept / iterate |
