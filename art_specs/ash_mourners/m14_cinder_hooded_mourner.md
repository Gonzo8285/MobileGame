# Per-card art spec — Cinder-Hooded Mourner
...
- **card_id:** M14
- **display_name:** Cinder-Hooded Mourner
...
```
low-rank mourner trailing cinder-smoke from torn court-shroud, ink-marked face below the hood, dusk-purple veil, ash drifting around bare feet, vault stone behind
```
...
- **seed:** 51414
- **rationale:** card_id digits → 14, formula 50000 + 101 × 14 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m14_cinder_hooded_mourner.png`
- **iterations_path:** `art_iterations/M14_cinder_hooded_mourner/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed51414_v1 | first pass — accept / iterate |
