...
```
black-veil-of-cinders descending around a kneeling mourner, no-shadow figures circling, raven-quill at the centre of the floor, gothic-vault background, dusk-purple drape
```
...
- **seed:** 53030
- **rationale:** card_id digits → 30, formula 50000 + 101 × 30 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m30_ash_veil.png`
- **iterations_path:** `art_iterations/M30_ash_veil/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed53030_v1 | first pass — accept / iterate |
