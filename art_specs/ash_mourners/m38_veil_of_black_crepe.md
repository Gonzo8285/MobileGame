# Per-card art spec — Veil of Black Crepe
...
- **card_id:** M38
- **display_name:** Veil of Black Crepe
...
```
black-crepe veil tumbling across a row of catacomb pews, ash drifting, raven-quill ribbon trailing, dusk-purple curtains caught mid-fall, candles guttering, no figures
```
...
- **seed:** 53838
- **rationale:** card_id digits → 38, formula 50000 + 101 × 38 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m38_veil_of_black_crepe.png`
- **iterations_path:** `art_iterations/M38_veil_of_black_crepe/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed53838_v1 | first pass — accept / iterate |
