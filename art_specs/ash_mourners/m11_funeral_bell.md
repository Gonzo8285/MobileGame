# Per-card art spec — Funeral Bell
...
```
enormous iron bell suspended in a gothic catacomb arch, dusk-purple bell-rope coiled into a snare, raven-quill anchored at the floor, ash-strewn stone, no figures
```
...
- **seed:** 51111
- **rationale:** card_id digits → 11, formula 50000 + 101 × 11 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m11_funeral_bell.png`
- **iterations_path:** `art_iterations/M11_funeral_bell/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed51111_v1 | first pass — accept / iterate |
