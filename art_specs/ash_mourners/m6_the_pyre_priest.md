# Per-card art spec — The Pyre-Priest
...
```
hollow-eyed priest stitched into burial robes, raising Ash Wraiths from the dead with a black ritual brand, raven-quill feathers crown, ink-soaked hands, gothic vault
```
...
- **seed:** 50606
- **rationale:** card_id digits → 6, formula 50000 + 101 × 6 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m6_the_pyre_priest.png`
- **iterations_path:** `art_iterations/M6_the_pyre_priest/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed50606_v1 | first pass — accept / iterate |
