# Per-card art spec — Mourning Acolyte
...
```
novice in dusk-purple court robes, ink-stained fingers, raven-feather collar, censer trailing thin smoke, head bowed in hood, no-shadow silhouette, candlelit catacomb stone behind
```
...
- **seed:** 50101
- **rationale:** card_id digits → 1, formula 50000 + 101 × 1 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m1_mourning_acolyte.png`
- **iterations_path:** `art_iterations/M1_mourning_acolyte/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed50101_v1 | first pass — accept / iterate |
