# Per-card art spec — Trap-Reader Acolyte
...
- **card_id:** M25
- **display_name:** Trap-Reader Acolyte
...
```
scholarly acolyte in court-mourning robe crouching over a trap-line of inked sigils, raven-quill in trembling hand, ink stains on cuffs, dusk-purple hood, vault stone
```
...
- **seed:** 52525
- **rationale:** card_id digits → 25, formula 50000 + 101 × 25 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m25_trap_reader_acolyte.png`
- **iterations_path:** `art_iterations/M25_trap_reader_acolyte/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed52525_v1 | first pass — accept / iterate |
