# Per-card art spec — The Long Dirge
...
```
vast hooded congregation singing in a gothic-vault nave, dusk-purple haze hanging over the pews, raven-quills raised, no-shadow figures bowed beneath funeral lanterns
```
...
- **seed:** 53636
- **rationale:** card_id digits → 36, formula 50000 + 101 × 36 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m36_the_long_dirge.png`
- **iterations_path:** `art_iterations/M36_the_long_dirge/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed53636_v1 | first pass — accept / iterate |
