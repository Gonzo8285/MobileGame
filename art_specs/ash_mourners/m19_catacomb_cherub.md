# Per-card art spec — Catacomb Cherub
...
```
small swaddled spectral child in court-shroud, eyeless, candle in cupped hands, ink stains running down the wrappings, gothic crypt arches, dusk-purple veil
```
...
- **seed:** 51919
- **rationale:** card_id digits → 19, formula 50000 + 101 × 19 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m19_catacomb_cherub.png`
- **iterations_path:** `art_iterations/M19_catacomb_cherub/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed51919_v1 | first pass — accept / iterate |
