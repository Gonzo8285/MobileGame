# Per-card art spec — Funeral Rites
...
```
black-robed gathering around a stone slab, censer-smoke pouring from the corpse, dusk-purple hangings, raven-quill ledgers open, candles around the bier, vault arches
```
...
- **seed:** 53131
- **rationale:** card_id digits → 31, formula 50000 + 101 × 31 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m31_funeral_rites.png`
- **iterations_path:** `art_iterations/M31_funeral_rites/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed53131_v1 | first pass — accept / iterate |
