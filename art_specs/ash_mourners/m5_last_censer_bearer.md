# Per-card art spec — Last Censer-Bearer
...
- **card_id:** M5
- **display_name:** Last Censer-Bearer
...
```
final survivor of a dead court swinging a vast tarnished censer of impossible weight, dread spreading like fog, raven-quill at belt, deep court-mourning veil over face
```
...
- **seed:** 50505
- **rationale:** card_id digits → 5, formula 50000 + 101 × 5 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m5_last_censer_bearer.png`
- **iterations_path:** `art_iterations/M5_last_censer_bearer/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed50505_v1 | first pass — accept / iterate |
