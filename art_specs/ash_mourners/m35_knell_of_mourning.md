# Per-card art spec — Knell of Mourning
...
- **card_id:** M35
- **display_name:** Knell of Mourning
...
```
great iron bell tolling alone in a smoke-filled crypt, dusk-purple bell-rope swaying, ash-coated stone floor, raven-quill resting at the bell's base, vault arches behind
```
...
- **seed:** 53535
- **rationale:** card_id digits → 35, formula 50000 + 101 × 35 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m35_knell_of_mourning.png`
- **iterations_path:** `art_iterations/M35_knell_of_mourning/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed53535_v1 | first pass — accept / iterate |
