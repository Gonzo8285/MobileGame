# Per-card art spec — Funeral Choir
...
```
trio silhouetted singing in court-mourning livery, hands raised, raven-quills clutched, dusk-purple haze hanging in the air, no-shadow figures, gothic loft behind
```
...
- **seed:** 51818
- **rationale:** card_id digits → 18, formula 50000 + 101 × 18 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m18_funeral_choir.png`
- **iterations_path:** `art_iterations/M18_funeral_choir/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed51818_v1 | first pass — accept / iterate |
