# Per-card art spec — Choir of the Long Dead
...
- **card_id:** M24
- **display_name:** Choir of the Long Dead
...
```
five spectral mourners in matching court-shrouds, mouths open in silent chord, dusk-purple haze, gothic-vault choir loft, no-shadow figures, raven-quill banners hanging
```
...
- **seed:** 52424
- **rationale:** card_id digits → 24, formula 50000 + 101 × 24 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m24_choir_of_the_long_dead.png`
- **iterations_path:** `art_iterations/M24_choir_of_the_long_dead/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed52424_v1 | first pass — accept / iterate |
