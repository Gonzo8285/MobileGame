# Per-card art spec — Cradle of the Dead
...
- **card_id:** M23
- **display_name:** Cradle of the Dead
...
```
ornate stone cradle full of court-shroud wrappings, faint Ash Wraith forming above it, raven feathers scattered, dusk-purple drape, crypt-vault background, candle smoke
```
...
- **seed:** 52323
- **rationale:** card_id digits → 23, formula 50000 + 101 × 23 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m23_cradle_of_the_dead.png`
- **iterations_path:** `art_iterations/M23_cradle_of_the_dead/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed52323_v1 | first pass — accept / iterate |
