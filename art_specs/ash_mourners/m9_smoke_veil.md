...
```
sudden curtain of dusk-purple smoke unfurling between two gothic-cathedral pillars, ash falling, no figure visible, hidden raven-quill ward etched on the stone floor
```
...
- **seed:** 50909
- **rationale:** card_id digits → 9, formula 50000 + 101 × 9 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m9_smoke_veil.png`
- **iterations_path:** `art_iterations/M9_smoke_veil/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed50909_v1 | first pass — accept / iterate |
