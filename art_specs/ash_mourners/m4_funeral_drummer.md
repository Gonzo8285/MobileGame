# Per-card art spec — Funeral Drummer
...
```
silent figure in funeral livery beating a slow muffled iron drum, ink-stained bandaged hands, dusk-purple shroud, court-mourner sigil on the drumhead, vault behind
```
...
- **seed:** 50404
- **rationale:** card_id digits → 4, formula 50000 + 101 × 4 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m4_funeral_drummer.png`
- **iterations_path:** `art_iterations/M4_funeral_drummer/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed50404_v1 | first pass — accept / iterate |
