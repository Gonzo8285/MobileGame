# Per-card art spec — Bone-Shroud Acolyte
...
- **card_id:** M20
- **display_name:** Bone-Shroud Acolyte
...
```
novice draped in bone-stitched shroud, knee-bent before a coffin, raven-quill in ink-stained hand, dusk-purple drape, vault background, single candle lighting the scene
```
...
- **seed:** 52020
- **rationale:** card_id digits → 20, formula 50000 + 101 × 20 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m20_bone_shroud_acolyte.png`
- **iterations_path:** `art_iterations/M20_bone_shroud_acolyte/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed52020_v1 | first pass — accept / iterate |
