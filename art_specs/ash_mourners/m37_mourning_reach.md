# Per-card art spec — Mourning Reach
...
```
hooded mourner's gloved hand stretched into the haze, raven-quill grasping a fading sigil, ink-stained sleeve, dusk-purple court-shroud, vault stone, candles flickering low
```
...
- **seed:** 53737
- **rationale:** card_id digits → 37, formula 50000 + 101 × 37 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m37_mourning_reach.png`
- **iterations_path:** `art_iterations/M37_mourning_reach/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed53737_v1 | first pass — accept / iterate |
