...
```
heavy court-shroud thrown over a pinned figure, dusk-purple cloth choking the air, raven-quill broken on the floor, single candle's last light, gothic vault floor
```
...
- **seed:** 50707
- **rationale:** card_id digits → 7, formula 50000 + 101 × 7 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m7_smother.png`
- **iterations_path:** `art_iterations/M7_smother/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed50707_v1 | first pass — accept / iterate |
