# Per-card art spec — Smoke-Walker
...
```
wraith-thin court-mourner stepping out of a column of incense smoke, half-dissolving, ink-marked fingers gripping a hooded staff, dusk-purple cloak, vault behind
```
...
- **seed:** 51616
- **rationale:** card_id digits → 16, formula 50000 + 101 × 16 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m16_smoke_walker.png`
- **iterations_path:** `art_iterations/M16_smoke_walker/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed51616_v1 | first pass — accept / iterate |
