# Per-card art spec — Sentinel of Pews
...
```
pale watch-mourner standing among gothic catacomb pews, dusk-purple cloak, holding a raven-quill ledger, ink-stained gloves, candlelit vault behind, no-shadow figure
```
...
- **seed:** 52626
- **rationale:** card_id digits → 26, formula 50000 + 101 × 26 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m26_sentinel_of_pews.png`
- **iterations_path:** `art_iterations/M26_sentinel_of_pews/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed52626_v1 | first pass — accept / iterate |
