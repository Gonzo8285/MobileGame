...
```
wave of grey cinder rolling across a stone aisle, shrouded mourners advancing through it, dusk-purple banners limp, ash settling on overturned pews, catacomb mouth ahead
```
...
- **seed:** 50808
- **rationale:** card_id digits → 8, formula 50000 + 101 × 8 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m8_cinder_tide.png`
- **iterations_path:** `art_iterations/M8_cinder_tide/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed50808_v1 | first pass — accept / iterate |
