# Per-card art spec — Veiled Reverent
...
```
kneeling reverent in heavy dusk-purple veil, eyes hidden, hands folded across raven-quill, smoke flowing past untouched, no-shadow stance, gothic catacomb floor
```
...
- **seed:** 51515
- **rationale:** card_id digits → 15, formula 50000 + 101 × 15 (Ash-Mourners faction tag = 5)
...
- **output_path:** `art/ash_mourners/m15_veiled_reverent.png`
- **iterations_path:** `art_iterations/M15_veiled_reverent/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed51515_v1 | first pass — accept / iterate |
