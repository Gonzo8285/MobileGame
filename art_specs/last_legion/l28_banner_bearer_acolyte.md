# Per-card art spec — Banner-Bearer Acolyte
...
- **card_id:** L28
- **display_name:** Banner-Bearer Acolyte
...
```
banner-bearer acolyte in foundry-rivet brigandine, brass officer gorget, ironwood pole, hammered-brass banner held upright, chain-bound hair, decayed-knight scale
```
...
- **seed:** 72828
- **rationale:** card_id digits → 28, formula 70000 + 101 × 28 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l28_banner_bearer_acolyte.png`
- **iterations_path:** `art_iterations/L28_banner_bearer_acolyte/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed72828_v1 | first pass — accept / iterate |
