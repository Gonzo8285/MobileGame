# Per-card art spec — Hammer-Stroke Doctrine
...
- **card_id:** L25
- **display_name:** Hammer-Stroke Doctrine
...
```
doctrine-banner ritual, Legion battalion below, hammers raised in synchronised echo across the row, brass-rivet standards, smoke-and-coal sky, decayed-knight scale
```
...
- **seed:** 72525
- **rationale:** card_id digits → 25, formula 70000 + 101 × 25 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l25_hammer_stroke_doctrine.png`
- **iterations_path:** `art_iterations/L25_hammer_stroke_doctrine/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed72525_v1 | first pass — accept / iterate |
