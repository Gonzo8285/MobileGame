...
```
drill-master shouting an order, ironwood baton raised high, soot-blackened cuirass, brass officer gorget, soldiers in disciplined rank below, smoke-and-coal forge-light
```
...
- **seed:** 71212
- **rationale:** card_id digits → 12, formula 70000 + 101 × 12 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l12_drill_order.png`
- **iterations_path:** `art_iterations/L12_drill_order/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed71212_v1 | first pass — accept / iterate |
