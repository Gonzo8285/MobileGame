# Per-card art spec — Crowned Anvil Standard
...
- **card_id:** L34
- **display_name:** Crowned Anvil Standard
...
```
towering Crowned Anvil Standard artifact-unit, hammered-brass anvil mounted on ironwood pole, crowned with iron crown, chain-bound to lane floor, foundry-rivet bracing, brass-glow aura
```
...
- **seed:** 73434
- **rationale:** card_id digits → 34, formula 70000 + 101 × 34 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l34_crowned_anvil_standard.png`
- **iterations_path:** `art_iterations/L34_crowned_anvil_standard/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed73434_v1 | first pass — accept / iterate |
