# Per-card art spec — Iron Choir-Standard
...
- **card_id:** L31
- **display_name:** Iron Choir-Standard
...
```
choir-standard bearer, foundry-rivet brigandine, brass officer gorget, ironwood pole, hammered-brass banner with iron-choir sigil, chain-bound hair, fearless decayed-knight bearing
```
...
- **seed:** 73131
- **rationale:** card_id digits → 31, formula 70000 + 101 × 31 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l31_iron_choir_standard.png`
- **iterations_path:** `art_iterations/L31_iron_choir_standard/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed73131_v1 | first pass — accept / iterate |
