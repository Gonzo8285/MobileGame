# Per-card art spec — Iron Watchwarden
...
```
heavy long-range warden in foundry-rivet plate, brass officer gorget, chain-bound hair beneath visored helm, ironwood baton extended, decayed-knight bearing, smoke-and-coal background
```
...
- **seed:** 70808
- **rationale:** card_id digits → 8, formula 70000 + 101 × 8 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l8_iron_watchwarden.png`
- **iterations_path:** `art_iterations/L8_iron_watchwarden/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed70808_v1 | first pass — accept / iterate |
