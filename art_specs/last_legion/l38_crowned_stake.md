# Per-card art spec — Crowned Stake
...
```
crowned-anvil stake driven into the lane, ironwood spike topped with crown sigil, brass-rivet sleeve, chain-loops dangling, brass-glow in forge-light, smoke-and-coal
```
...
- **seed:** 73838
- **rationale:** card_id digits → 38, formula 70000 + 101 × 38 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l38_crowned_stake.png`
- **iterations_path:** `art_iterations/L38_crowned_stake/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed73838_v1 | first pass — accept / iterate |
