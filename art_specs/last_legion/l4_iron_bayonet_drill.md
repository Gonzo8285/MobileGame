# Per-card art spec — Iron Bayonet Drill
...
- **card_id:** L4
- **display_name:** Iron Bayonet Drill
...
```
bayonet-tipped drill-rifle leveled, foundry-rivet armour, brass officer gorget reflecting forge-glow, chain-bound hair, decayed-knight elden-ring scale, smoke-and-coal lockstep behind
```
...
- **seed:** 70404
- **rationale:** card_id digits → 4, formula 70000 + 101 × 4 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l4_iron_bayonet_drill.png`
- **iterations_path:** `art_iterations/L4_iron_bayonet_drill/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed70404_v1 | first pass — accept / iterate |
