# Per-card art spec — Banner-Defence Trap
...
- **card_id:** L37
- **display_name:** Banner-Defence Trap
...
```
hidden defensive trap rigged at a banner-base, ironwood spike-frame, brass-spring tension, foundry-rivet bracket, chain-loop tripwires, smoke-and-coal hanging in the air
```
...
- **seed:** 73737
- **rationale:** card_id digits → 37, formula 70000 + 101 × 37 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l37_banner_defence_trap.png`
- **iterations_path:** `art_iterations/L37_banner_defence_trap/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed73737_v1 | first pass — accept / iterate |
