# Per-card art spec — Standard-Bearer's Cry
...
- **card_id:** L35
- **display_name:** Standard-Bearer's Cry
...
```
rallying cry from a standard-bearer, mouth open in command, brass officer gorget, hammered-brass standard tilted forward, chain-bound hair caught mid-shout, smoke-and-coal lane
```
...
- **seed:** 73535
- **rationale:** card_id digits → 35, formula 70000 + 101 × 35 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l35_standard_bearers_cry.png`
- **iterations_path:** `art_iterations/L35_standard_bearers_cry/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed73535_v1 | first pass — accept / iterate |
