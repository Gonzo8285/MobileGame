# Per-card art spec — Banner-Sergeant of Vanrik
...
- **card_id:** L32
- **display_name:** Banner-Sergeant of Vanrik
...
```
sergeant of the Vanrik banner-line, soot-blackened cuirass, brass officer gorget, ironwood pole, hammered-brass standard, chain-bound hair, decayed-knight elden-ring scale
```
...
- **seed:** 73232
- **rationale:** card_id digits → 32, formula 70000 + 101 × 32 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l32_banner_sergeant_of_vanrik.png`
- **iterations_path:** `art_iterations/L32_banner_sergeant_of_vanrik/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed73232_v1 | first pass — accept / iterate |
