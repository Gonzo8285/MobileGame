...
```
Legion battalion shifting into formation, foundry-rivet armour, brass officer gorgets reflecting forge-light, chain-bound hair under helms, ironwood pikes raised, smoke-and-coal lane
```
...
- **seed:** 71111
- **rationale:** card_id digits → 11, formula 70000 + 101 × 11 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l11_form_ranks.png`
- **iterations_path:** `art_iterations/L11_form_ranks/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed71111_v1 | first pass — accept / iterate |
