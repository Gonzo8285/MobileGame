# Per-card art spec — Foundry Engineer
...
```
grizzled engineer in soot-blackened apron over brigandine, brass-rimmed goggles, hammer at belt, blueprint scrolls tucked, ironwood baton, smoke-and-coal forge behind
```
...
- **seed:** 70505
- **rationale:** card_id digits → 5, formula 70000 + 101 × 5 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l5_foundry_engineer.png`
- **iterations_path:** `art_iterations/L5_foundry_engineer/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed70505_v1 | first pass — accept / iterate |
