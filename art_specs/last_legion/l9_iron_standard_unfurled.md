# Per-card art spec — Iron Standard Unfurled
...
- **card_id:** L9
- **display_name:** Iron Standard Unfurled
...
```
wide unfurling iron banner over the Last Legion lane, hammered-brass standard catching forge-light, soot-blackened soldiers below in lockstep, smoke-and-coal sky
```
...
- **seed:** 70909
- **rationale:** card_id digits → 9, formula 70000 + 101 × 9 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l9_iron_standard_unfurled.png`
- **iterations_path:** `art_iterations/L9_iron_standard_unfurled/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed70909_v1 | first pass — accept / iterate |
