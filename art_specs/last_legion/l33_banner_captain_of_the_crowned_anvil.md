# Per-card art spec — Banner-Captain of the Crowned Anvil
...
- **card_id:** L33
- **display_name:** Banner-Captain of the Crowned Anvil
...
```
captain of the Crowned Anvil banner-line, soot-blackened cuirass, brass officer gorget heavy with crowned-anvil pins, ironwood pole-haft, hammered-brass standard, chain-bound greying hair, decayed-knight scale
```
...
- **seed:** 73333
- **rationale:** card_id digits → 33, formula 70000 + 101 × 33 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l33_banner_captain_of_the_crowned_anvil.png`
- **iterations_path:** `art_iterations/L33_banner_captain_of_the_crowned_anvil/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed73333_v1 | first pass — accept / iterate |
