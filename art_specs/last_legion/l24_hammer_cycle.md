# Per-card art spec — Hammer-Cycle
...
```
three-blow hammer-cycle in ghosted afterimage, soldier mid-swing, foundry-rivet armour, brass officer gorget, brass-glowing weapon-trail, smoke-and-coal forge-haze
```
...
- **seed:** 72424
- **rationale:** card_id digits → 24, formula 70000 + 101 × 24 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l24_hammer_cycle.png`
- **iterations_path:** `art_iterations/L24_hammer_cycle/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed72424_v1 | first pass — accept / iterate |
