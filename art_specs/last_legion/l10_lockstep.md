...
```
row of Legion soldiers snapping into lockstep, brass-rivet shoulders aligning, ironwood batons lowered in unison, foundry-rivet armour gleaming, smoke-and-coal hanging in the lane
```
...
- **seed:** 71010
- **rationale:** card_id digits → 10, formula 70000 + 101 × 10 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l10_lockstep.png`
- **iterations_path:** `art_iterations/L10_lockstep/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed71010_v1 | first pass — accept / iterate |
