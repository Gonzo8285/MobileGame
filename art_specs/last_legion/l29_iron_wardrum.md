# Per-card art spec — Iron Wardrum
...
```
great iron wardrum mounted on a brass-rivet stand, ironwood drumstick resting against the rim, chain-bound to the lane floor, foundry-rivet bracing, smoke-and-coal hanging
```
...
- **seed:** 72929
- **rationale:** card_id digits → 29, formula 70000 + 101 × 29 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l29_iron_wardrum.png`
- **iterations_path:** `art_iterations/L29_iron_wardrum/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed72929_v1 | first pass — accept / iterate |
