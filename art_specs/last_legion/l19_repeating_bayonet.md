# Per-card art spec — Repeating Bayonet
...
- **card_id:** L19
- **display_name:** Repeating Bayonet
...
```
bayonet-corps soldier in foundry-rivet plate, brass officer gorget, chain-bound hair, ironwood-stocked rifle held in repeating-strike pose, decayed-knight bearing, smoke-and-coal
```
...
- **seed:** 71919
- **rationale:** card_id digits → 19, formula 70000 + 101 × 19 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l19_repeating_bayonet.png`
- **iterations_path:** `art_iterations/L19_repeating_bayonet/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed71919_v1 | first pass — accept / iterate |
