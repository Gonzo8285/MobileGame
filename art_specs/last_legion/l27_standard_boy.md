# Per-card art spec — Standard-Boy
...
```
young standard-boy clutching an iron pennant, oversized soot-blackened tabard, brass-rivet sash, chain-bound hair, ironwood pole-haft, smoke-and-coal background
```
...
- **seed:** 72727
- **rationale:** card_id digits → 27, formula 70000 + 101 × 27 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l27_standard_boy.png`
- **iterations_path:** `art_iterations/L27_standard_boy/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed72727_v1 | first pass — accept / iterate |
