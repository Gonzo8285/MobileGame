# Per-card art spec — Crown-Anvil Veteran
...
- **card_id:** L30
- **display_name:** Crown-Anvil Veteran
...
```
grizzled veteran of the Crown-Anvil, soot-blackened cuirass, brass officer gorget heavy with service-pins, chain-bound greying hair, ironwood baton at side, decayed-knight
```
...
- **seed:** 73030
- **rationale:** card_id digits → 30, formula 70000 + 101 × 30 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l30_crown_anvil_veteran.png`
- **iterations_path:** `art_iterations/L30_crown_anvil_veteran/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed73030_v1 | first pass — accept / iterate |
