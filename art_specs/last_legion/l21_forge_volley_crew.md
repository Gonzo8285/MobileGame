# Per-card art spec — Forge-Volley Crew
...
- **card_id:** L21
- **display_name:** Forge-Volley Crew
...
```
two-soldier volley crew, foundry-rivet armour, brass officer gorgets, chain-bound hair, long-arm rifles braced and loosing in echo, smoke-and-coal volley
```
...
- **seed:** 72121
- **rationale:** card_id digits → 21, formula 70000 + 101 × 21 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l21_forge_volley_crew.png`
- **iterations_path:** `art_iterations/L21_forge_volley_crew/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed72121_v1 | first pass — accept / iterate |
