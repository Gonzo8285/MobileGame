...
```
junior cadet in foundry-rivet armour, brass officer-cadet gorget, chain-bound hair, drillbook tucked at belt, ironwood baton, hammer-pulse satchel, smoke-and-coal courtyard
```
...
- **seed:** 71515
- **rationale:** card_id digits → 15, formula 70000 + 101 × 15 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l15_echo_cadet.png`
- **iterations_path:** `art_iterations/L15_echo_cadet/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed71515_v1 | first pass — accept / iterate |
