# Per-card art spec — Echo-Sergeant
...
```
drill-master of the echo doctrine, soot-blackened cuirass, brass officer gorget, ironwood baton orchestrating two strikes, chain-bound hair, decayed-knight elden-ring scale, ghost-echo afterimage behind
```
...
- **seed:** 71818
- **rationale:** card_id digits → 18, formula 70000 + 101 × 18 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l18_echo_sergeant.png`
- **iterations_path:** `art_iterations/L18_echo_sergeant/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed71818_v1 | first pass — accept / iterate |
