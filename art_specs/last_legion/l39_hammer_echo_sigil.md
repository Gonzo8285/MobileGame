# Per-card art spec — Hammer-Echo Sigil
...
- **card_id:** L39
- **display_name:** Hammer-Echo Sigil
...
```
brass-rivet sigil-disc inscribed with hammer-echo pattern, hung on chain-bound iron clasp, twin-hammer afterimage glow, ironwood plinth, smoke-and-coal background
```
...
- **seed:** 73939
- **rationale:** card_id digits → 39, formula 70000 + 101 × 39 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l39_hammer_echo_sigil.png`
- **iterations_path:** `art_iterations/L39_hammer_echo_sigil/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed73939_v1 | first pass — accept / iterate |
