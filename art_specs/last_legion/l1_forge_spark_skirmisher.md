# Per-card art spec — Forge-Spark Skirmisher
...
- **card_id:** L1
- **display_name:** Forge-Spark Skirmisher
...
```
swift skirmisher in light foundry-rivet harness, brass-button tunic, ironwood baton at hip, sparks at heel, chain-bound hair, soot-blackened pauldron, smoke-and-coal trailing
```
...
- **seed:** 70101
- **rationale:** card_id digits → 1, formula 70000 + 101 × 1 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l1_forge_spark_skirmisher.png`
- **iterations_path:** `art_iterations/L1_forge_spark_skirmisher/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed70101_v1 | first pass — accept / iterate |
