# Per-card art spec — Forge-Conscript
...
```
conscript pressed into the line, ill-fitting foundry-rivet armour, brass gorget too large, chain-bound hair, ironwood baton at side, weary smoke-and-coal stare
```
...
- **seed:** 70606
- **rationale:** card_id digits → 6, formula 70000 + 101 × 6 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l6_forge_conscript.png`
- **iterations_path:** `art_iterations/L6_forge_conscript/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed70606_v1 | first pass — accept / iterate |
