# Per-card art spec — Forge-Light Runner
...
- **card_id:** L14
- **display_name:** Forge-Light Runner
...
```
swift runner in light foundry-rivet harness, brass-button tunic, ironwood baton in hand, chain-bound hair caught mid-stride, sparks at heels, smoke-and-coal trailing
```
...
- **seed:** 71414
- **rationale:** card_id digits → 14, formula 70000 + 101 × 14 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l14_forge_light_runner.png`
- **iterations_path:** `art_iterations/L14_forge_light_runner/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed71414_v1 | first pass — accept / iterate |
