# Per-card art spec — Drum-Sergeant of the Foundry
...
- **card_id:** L20
- **display_name:** Drum-Sergeant of the Foundry
...
```
drum-sergeant beating a forge-drum, soot-blackened cuirass, brass officer gorget, ironwood drumstick, brass-rimmed drum, decayed-knight elden-ring scale, smoke-and-coal
```
...
- **seed:** 72020
- **rationale:** card_id digits → 20, formula 70000 + 101 × 20 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l20_drum_sergeant_of_the_foundry.png`
- **iterations_path:** `art_iterations/L20_drum_sergeant_of_the_foundry/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed72020_v1 | first pass — accept / iterate |
