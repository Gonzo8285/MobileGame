# Per-card art spec — Bayonet Echoist
...
```
bayonet-rifle drilled twice in succession, foundry-rivet brigandine, brass officer gorget, chain-bound hair, ghost after-image of the second strike, smoke-and-coal background
```
...
- **seed:** 71616
- **rationale:** card_id digits → 16, formula 70000 + 101 × 16 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l16_bayonet_echoist.png`
- **iterations_path:** `art_iterations/L16_bayonet_echoist/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed71616_v1 | first pass — accept / iterate |
