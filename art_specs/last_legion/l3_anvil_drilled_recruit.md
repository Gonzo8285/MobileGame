# Per-card art spec — Anvil-Drilled Recruit
...
- **card_id:** L3
- **display_name:** Anvil-Drilled Recruit
...
```
green recruit in oversized soot-blackened cuirass, brass-button tunic, hammer at belt, ironwood baton awkwardly held, drill-stance, chain-bound hair, smoke-and-coal forge-haze behind
```
...
- **seed:** 70303
- **rationale:** card_id digits → 3, formula 70000 + 101 × 3 (Last Legion faction tag = 7)
...
- **output_path:** `art/last_legion/l3_anvil_drilled_recruit.png`
- **iterations_path:** `art_iterations/L3_anvil_drilled_recruit/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed70303_v1 | first pass — accept / iterate |
