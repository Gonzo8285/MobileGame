# Per-card art spec — Carrion Hound
...
```
lean half-rotten swamp-hound mid-lunge, ribcage exposed under matted
bog-soaked fur, bog-green pyre eyes, lips peeled back over yellow teeth,
fungal moss clinging to flank, fast and gluttonous
```
...
- **seed:** 90202
- **rationale:** card_id digits → 2, formula 90000 + 101 × 2 (Enemy faction tag = 9)
...
- **output_path:** `art/enemies/e2_carrion_hound.png`
- **iterations_path:** `art_iterations/E2_carrion_hound/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed90202_v1 | first pass — accept / iterate |
