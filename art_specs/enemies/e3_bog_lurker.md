...
```
hulking moss-cloaked figure rising waist-deep from black mire, slow
patient menace, fungal carapace plates, unblinking bog-green pyre eyes,
briar-tangled cloak dripping swamp-water, doesn't hurry, doesn't stop
```
...
- **loras:**
  ...
  - `Mythical Forest Style [SDXL]` @ 0.5      ← Coven faction LoRA, trigger `ral-mytfrst`
...
- **seed:** 90303
- **rationale:** card_id digits → 3, formula 90000 + 101 × 3 (Enemy faction tag = 9)
...
- **output_path:** `art/enemies/e3_bog_lurker.png`
- **iterations_path:** `art_iterations/E3_bog_lurker/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed90303_v1 | first pass — accept / iterate |
...
- [ ] Faction palette holds — bog-green accent, not lime or neon
- [ ] Body-horror tolerance — Phyrexian / lorwyn-grotesque undertone, no explicit gore
