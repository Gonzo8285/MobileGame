...
```
hidden briar snare half-buried in mire-mud, thorned tendrils coiled tight, demon-coin used as bait at the centre, bog-green pyre flickering, three coiling shadows
```
...
- **seed:** 61010
- **rationale:** card_id digits → 10, formula 60000 + 101 × 10 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c10_briar_snare.png`
- **iterations_path:** `art_iterations/C10_briar_snare/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed61010_v1 | first pass — accept / iterate |
