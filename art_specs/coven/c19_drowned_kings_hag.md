# Per-card art spec — Drowned-King's Hag
...
- **card_id:** C19
- **display_name:** Drowned-King's Hag
...
```
crowned hag with kelp diadem dripping bog-water, briar-tangled regal cloak, demon-coins woven through hair, three shadows arrayed like court courtiers
```
...
- **seed:** 61919
- **rationale:** card_id digits → 19, formula 60000 + 101 × 19 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c19_drowned_kings_hag.png`
- **iterations_path:** `art_iterations/C19_drowned_kings_hag/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed61919_v1 | first pass — accept / iterate |
