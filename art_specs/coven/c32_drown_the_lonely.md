# Per-card art spec — Drown the Lonely
...
```
witch holding an enemy's head under bog-water, demon-coin sinking from her sleeve, briar cloak, fungal-grove gloom behind, three shadows watching
```
...
- **seed:** 63232
- **rationale:** card_id digits → 32, formula 60000 + 101 × 32 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c32_drown_the_lonely.png`
- **iterations_path:** `art_iterations/C32_drown_the_lonely/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed63232_v1 | first pass — accept / iterate |
