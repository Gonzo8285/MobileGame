# Per-card art spec — Pact of Black Mire
...
- **card_id:** C31
- **display_name:** Pact of Black Mire
...
```
sacrifice-pact ritual on a fungal-grove altar, briar-bound initiate kneeling, bog-green flames consuming a demon-coin, three witnessing shadows around the stone
```
...
- **seed:** 63131
- **rationale:** card_id digits → 31, formula 60000 + 101 × 31 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c31_pact_of_black_mire.png`
- **iterations_path:** `art_iterations/C31_pact_of_black_mire/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed63131_v1 | first pass — accept / iterate |
