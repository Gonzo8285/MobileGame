...
```
old crone hunched over a clay bowl of bog-tea, dripping ladle, three shadows cast against the fungal-grove wall, briar-tangled shawl, demon-coin earrings
```
...
- **seed:** 61616
- **rationale:** card_id digits → 16, formula 60000 + 101 × 16 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c16_marsh_crone.png`
- **iterations_path:** `art_iterations/C16_marsh_crone/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed61616_v1 | first pass — accept / iterate |
