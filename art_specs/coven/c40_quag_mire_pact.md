# Per-card art spec — Quag-Mire Pact
...
```
ancient pact-stone half-sunk in the mire, demon-coin sigils carved across it bleeding bog-green light, briar tendrils lashed to its base, three witnessing shadows
```
...
- **seed:** 64040
- **rationale:** card_id digits → 40, formula 60000 + 101 × 40 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c40_quag_mire_pact.png`
- **iterations_path:** `art_iterations/C40_quag_mire_pact/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed64040_v1 | first pass — accept / iterate |
