# Per-card art spec — Hag of the Bone-Coin
...
- **card_id:** C26
- **display_name:** Hag of the Bone-Coin
...
```
hag holding a bone-coin between two fingers, sacrificed bog-spawn at her feet, briar cloak, demon-coin necklace, green pyre eyes
```
...
- **seed:** 62626
- **rationale:** card_id digits → 26, formula 60000 + 101 × 26 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c26_hag_of_the_bone_coin.png`
- **iterations_path:** `art_iterations/C26_hag_of_the_bone_coin/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed62626_v1 | first pass — accept / iterate |
