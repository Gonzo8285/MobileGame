# Per-card art spec — Brood-Mother of the Mire
...
- **card_id:** C12
- **display_name:** Brood-Mother of the Mire
...
```
hulking brood-mother spilling spawn from beneath her cloak, briar-tangled body, demon-coin pendant, green pyre eyes, three shadows stretching into the fungal-grove
```
...
- **seed:** 61212
- **rationale:** card_id digits → 12, formula 60000 + 101 × 12 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c12_brood_mother_of_the_mire.png`
- **iterations_path:** `art_iterations/C12_brood_mother_of_the_mire/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed61212_v1 | first pass — accept / iterate |
