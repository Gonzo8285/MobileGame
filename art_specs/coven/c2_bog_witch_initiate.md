# Per-card art spec — Bog-Witch Initiate
...
- **card_id:** C2
- **display_name:** Bog-Witch Initiate
...
```
first-summer initiate clutching a coin pouch, briar-tangled novice cloak, bog-green eyes only just lit, three half-shadows trailing, fungal-grove novice
```
...
- **seed:** 60202
- **rationale:** card_id digits → 2, formula 60000 + 101 × 2 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c2_bog_witch_initiate.png`
- **iterations_path:** `art_iterations/C2_bog_witch_initiate/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed60202_v1 | first pass — accept / iterate |
