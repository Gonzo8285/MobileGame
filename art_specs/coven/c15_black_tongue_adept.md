# Per-card art spec — Black-Tongue Adept
...
- **card_id:** C15
- **display_name:** Black-Tongue Adept
...
```
adept with tongue blackened by mire-poison, hand mid-gesture casting venom, briar-tangled cloak, demon-coin pendant, green pyre flickering in his throat
```
...
- **seed:** 61515
- **rationale:** card_id digits → 15, formula 60000 + 101 × 15 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c15_black_tongue_adept.png`
- **iterations_path:** `art_iterations/C15_black_tongue_adept/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed61515_v1 | first pass — accept / iterate |
