...
```
sister-witch in patched briar cloak, bog-green warpaint dripping, demon-coin pouch tied at her hip, three shadows reaching for her, fungal-grove gloom behind
```
...
- **seed:** 62020
- **rationale:** card_id digits → 20, formula 60000 + 101 × 20 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c20_mire_sister.png`
- **iterations_path:** `art_iterations/C20_mire_sister/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed62020_v1 | first pass — accept / iterate |
