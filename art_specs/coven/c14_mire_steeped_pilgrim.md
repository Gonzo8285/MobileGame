# Per-card art spec — Mire-Steeped Pilgrim
...
- **card_id:** C14
- **display_name:** Mire-Steeped Pilgrim
...
```
young pilgrim soaked in bog-water to the chest, bog-green stain climbing his briar cloak, demon-coin tucked at his belt, three faint shadows behind
```
...
- **seed:** 61414
- **rationale:** card_id digits → 14, formula 60000 + 101 × 14 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c14_mire_steeped_pilgrim.png`
- **iterations_path:** `art_iterations/C14_mire_steeped_pilgrim/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed61414_v1 | first pass — accept / iterate |
