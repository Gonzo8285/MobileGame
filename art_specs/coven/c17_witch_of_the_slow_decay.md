# Per-card art spec — Witch of the Slow Decay
...
- **card_id:** C17
- **display_name:** Witch of the Slow Decay
...
```
slow-decay witch wreathed in creeping rot vines, hands tracing curse-circles, demon-coin wreath, green pyre eyes, three shadows feeding the rot
```
...
- **seed:** 61717
- **rationale:** card_id digits → 17, formula 60000 + 101 × 17 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c17_witch_of_the_slow_decay.png`
- **iterations_path:** `art_iterations/C17_witch_of_the_slow_decay/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed61717_v1 | first pass — accept / iterate |
