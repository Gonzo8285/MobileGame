# Per-card art spec — The Sodden Penitent
...
- **card_id:** C28
- **display_name:** The Sodden Penitent
...
```
sodden bog-pilgrim kneeling chest-deep in mire, hands pressed in soaked prayer, briar-tangled cloak, demon-coin around her throat, three shadows sinking with her
```
...
- **seed:** 62828
- **rationale:** card_id digits → 28, formula 60000 + 101 × 28 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c28_the_sodden_penitent.png`
- **iterations_path:** `art_iterations/C28_the_sodden_penitent/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed62828_v1 | first pass — accept / iterate |
