# Per-card art spec — Toad-Choir Witch
...
```
witch conducting a chorus of bog-toads with a raised bone wand, briar cloak open, demon-coin medallion, green pyre eyes, three shadows joining the song
```
...
- **seed:** 62121
- **rationale:** card_id digits → 21, formula 60000 + 101 × 21 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c21_toad_choir_witch.png`
- **iterations_path:** `art_iterations/C21_toad_choir_witch/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed62121_v1 | first pass — accept / iterate |
