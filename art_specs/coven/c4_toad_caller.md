...
```
silent witch summoning a chorus of bog-toads, bone whistle in hand, briar cloak, demon-coin wreath, green pyre eyes, fungal-grove vista behind
```
...
- **seed:** 60404
- **rationale:** card_id digits → 4, formula 60000 + 101 × 4 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c4_toad_caller.png`
- **iterations_path:** `art_iterations/C4_toad_caller/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed60404_v1 | first pass — accept / iterate |
