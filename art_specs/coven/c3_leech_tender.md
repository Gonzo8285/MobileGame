# Per-card art spec — Leech-Tender
...
```
leech-handed swamp-witch holding writhing leeches like rope, demon-coin necklace dripping, green pyre eyes, three-shadows-cast, briar-tangled cloak
```
...
- **seed:** 60303
- **rationale:** card_id digits → 3, formula 60000 + 101 × 3 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c3_leech_tender.png`
- **iterations_path:** `art_iterations/C3_leech_tender/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed60303_v1 | first pass — accept / iterate |
