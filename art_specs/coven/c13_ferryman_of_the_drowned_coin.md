# Per-card art spec — Ferryman of the Drowned Coin
...
- **card_id:** C13
- **display_name:** Ferryman of the Drowned Coin
...
```
hooded ferryman pulling drowned coin from the bog with a bone hook, three shadows on the water, demon-coin pile in his keelboat, green pyre eyes, fungal-grove riverbank
```
...
- **seed:** 61313
- **rationale:** card_id digits → 13, formula 60000 + 101 × 13 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c13_ferryman_of_the_drowned_coin.png`
- **iterations_path:** `art_iterations/C13_ferryman_of_the_drowned_coin/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed61313_v1 | first pass — accept / iterate |
