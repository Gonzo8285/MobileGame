...
```
single bog-green poison bubble surfacing in still mire-water, demon-coin glinting beneath, briar-tangled reeds at the edge, three faint shadows on the surface
```
...
- **seed:** 60707
- **rationale:** card_id digits → 7, formula 60000 + 101 × 7 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c7_bog_bubble.png`
- **iterations_path:** `art_iterations/C7_bog_bubble/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed60707_v1 | first pass — accept / iterate |
