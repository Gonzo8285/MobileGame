# Per-card art spec — Sigil-Drawn Bog-Witch
...
- **card_id:** C23
- **display_name:** Sigil-Drawn Bog-Witch
...
```
sigil-witch drawing bog-green runes in mid-air around a kneeling bog-spawn, briar-tangled cloak, demon-coin wreath, three shadows aligning to the runes
```
...
- **seed:** 62323
- **rationale:** card_id digits → 23, formula 60000 + 101 × 23 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c23_sigil_drawn_bog_witch.png`
- **iterations_path:** `art_iterations/C23_sigil_drawn_bog_witch/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed62323_v1 | first pass — accept / iterate |
