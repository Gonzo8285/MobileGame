...
```
glowing bog-green sigil burned into mire-mud, three lashing shadows around it, briar-tangled tendrils sprouting at the sigil's edges, fungal-grove gloom
```
...
- **seed:** 63333
- **rationale:** card_id digits → 33, formula 60000 + 101 × 33 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c33_bog_sigil.png`
- **iterations_path:** `art_iterations/C33_bog_sigil/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed63333_v1 | first pass — accept / iterate |
