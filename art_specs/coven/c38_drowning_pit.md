# Per-card art spec — Drowning Pit
...
```
hidden bog-pit ringed by briar-tangled roots, surface a still demon-coin pattern, two bog-spawn watching from cover, fungal-grove canopy above
```
...
- **seed:** 63838
- **rationale:** card_id digits → 38, formula 60000 + 101 × 38 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c38_drowning_pit.png`
- **iterations_path:** `art_iterations/C38_drowning_pit/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed63838_v1 | first pass — accept / iterate |
