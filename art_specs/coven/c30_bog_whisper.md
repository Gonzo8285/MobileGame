...
```
witch leaning into the bog-water to whisper a curse, ripples carrying bog-green poison, briar cloak, demon-coin pendant, three shadows on the surface
```
...
- **seed:** 63030
- **rationale:** card_id digits → 30, formula 60000 + 101 × 30 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c30_bog_whisper.png`
- **iterations_path:** `art_iterations/C30_bog_whisper/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed63030_v1 | first pass — accept / iterate |
