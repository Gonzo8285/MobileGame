# Per-card art spec — Antler Crown
...
```
antler crown of bone and briar floating above a sacrificed bog-spawn, bog-green light curling upward, demon-coin embedded in the central tine, three shadows kneeling
```
...
- **seed:** 60808
- **rationale:** card_id digits → 8, formula 60000 + 101 × 8 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c8_antler_crown.png`
- **iterations_path:** `art_iterations/C8_antler_crown/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed60808_v1 | first pass — accept / iterate |
