# Per-card art spec — The Drowned Coin
...
```
single demon-coin glowing bog-green at the bottom of a still bog-pool, briar tendrils encircling it, three shadows on the water's surface, fungal-grove gloom
```
...
- **seed:** 63939
- **rationale:** card_id digits → 39, formula 60000 + 101 × 39 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c39_the_drowned_coin.png`
- **iterations_path:** `art_iterations/C39_the_drowned_coin/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed63939_v1 | first pass — accept / iterate |
