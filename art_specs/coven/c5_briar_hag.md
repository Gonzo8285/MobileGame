...
```
hag wreathed in cutting briar, hands wet with sacrificed initiate's offering, demon-coin sigil burning bog-green, three shadows splayed wide
```
...
- **seed:** 60505
- **rationale:** card_id digits → 5, formula 60000 + 101 × 5 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c5_briar_hag.png`
- **iterations_path:** `art_iterations/C5_briar_hag/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed60505_v1 | first pass — accept / iterate |
