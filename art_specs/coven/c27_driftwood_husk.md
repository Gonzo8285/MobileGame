# Per-card art spec — Driftwood Husk
...
```
hollow driftwood husk shaped like a man, bog-water dripping from gaps in its torso, demon-coins rattling inside the chest cavity, fungal-grove root through its leg
```
...
- **seed:** 62727
- **rationale:** card_id digits → 27, formula 60000 + 101 × 27 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c27_driftwood_husk.png`
- **iterations_path:** `art_iterations/C27_driftwood_husk/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed62727_v1 | first pass — accept / iterate |
