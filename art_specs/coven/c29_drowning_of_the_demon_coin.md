# Per-card art spec — Drowning of the Demon-Coin
...
- **card_id:** C29
- **display_name:** Drowning of the Demon-Coin
...
```
vast bog-pool exploding with bog-green light as three demon-coins sink, briar-tangled witches casting from the bank, fungal-grove canopy mirroring the discharge
```
...
- **seed:** 62929
- **rationale:** card_id digits → 29, formula 60000 + 101 × 29 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c29_drowning_of_the_demon_coin.png`
- **iterations_path:** `art_iterations/C29_drowning_of_the_demon_coin/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed62929_v1 | first pass — accept / iterate |
