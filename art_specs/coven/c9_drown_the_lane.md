# Per-card art spec — Drown the Lane
...
```
row-wide flood of black mire water surging across the lane, drowned-coin sigils glowing bog-green in the rising tide, briar tendrils dragging at the surface
```
...
- **seed:** 60909
- **rationale:** card_id digits → 9, formula 60000 + 101 × 9 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c9_drown_the_lane.png`
- **iterations_path:** `art_iterations/C9_drown_the_lane/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed60909_v1 | first pass — accept / iterate |
