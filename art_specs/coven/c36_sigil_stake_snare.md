# Per-card art spec — Sigil-Stake Snare
...
- **card_id:** C36
- **display_name:** Sigil-Stake Snare
...
```
briar-bound stake driven into bog-mud, demon-coin sigil carved on its head, bog-green mist coiling around it, three faint shadows of an unseen trap-layer
```
...
- **seed:** 63636
- **rationale:** card_id digits → 36, formula 60000 + 101 × 36 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c36_sigil_stake_snare.png`
- **iterations_path:** `art_iterations/C36_sigil_stake_snare/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed63636_v1 | first pass — accept / iterate |
