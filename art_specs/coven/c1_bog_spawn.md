...
```
hunched bog-spawn larva of muck and reed, mottled bog-green skin, three weak shadows trailing, briar tendrils sprouting from its hide, lorwyn-folkloric grotesque
```
...
- **seed:** 60101
- **rationale:** card_id digits → 1, formula 60000 + 101 × 1 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c1_bog_spawn.png`
- **iterations_path:** `art_iterations/C1_bog_spawn/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed60101_v1 | first pass — accept / iterate |
