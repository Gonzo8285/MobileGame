...
```
hex-circle of demon-coins half-buried in mire, briar tendrils tightening as the trap arms, bog-green pyre flickering at the centre, three coiling shadows
```
...
- **seed:** 63737
- **rationale:** card_id digits → 37, formula 60000 + 101 × 37 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c37_covens_hex.png`
- **iterations_path:** `art_iterations/C37_covens_hex/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed63737_v1 | first pass — accept / iterate |
