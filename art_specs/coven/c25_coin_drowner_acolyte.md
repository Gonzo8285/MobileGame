# Per-card art spec — Coin-Drowner Acolyte
...
- **card_id:** C25
- **display_name:** Coin-Drowner Acolyte
...
```
acolyte sinking a single demon-coin into a still bog-pool, ripple of bog-green light spreading, briar cloak, three shadows on the rising surface
```
...
- **seed:** 62525
- **rationale:** card_id digits → 25, formula 60000 + 101 × 25 (Coven faction tag = 6)
...
- **output_path:** `art/coven/c25_coin_drowner_acolyte.png`
- **iterations_path:** `art_iterations/C25_coin_drowner_acolyte/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed62525_v1 | first pass — accept / iterate |
