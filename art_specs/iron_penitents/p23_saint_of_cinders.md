# Per-card art spec — Saint of Cinders
...
```
burning saint half-consumed by ceremonial pyre, serene face wreathed in fire,
ember-red coal eyes, ash-body intact, allies' deaths fuelling her ascension
```
...
- **seed:** 42323
- **rationale:** card_id digits → 23, formula 40000 + 101 × 23
...
- **output_path:** `art/iron_penitents/p23_saint_of_cinders.png`
- **iterations_path:** `art_iterations/P23_saint_of_cinders/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed42323_v1 | first pass — accept / iterate |
