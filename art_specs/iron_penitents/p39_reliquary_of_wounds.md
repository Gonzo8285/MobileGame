# Per-card art spec — Reliquary of Wounds
...
- **card_id:** P39
- **display_name:** Reliquary of Wounds
...
```
ornate iron reliquary box cracked open, pressed wounds behind glass-pane windows
radiating rust-red curse-energy, seams bleeding light, displayed on a stone altar in shadow
```
...
- **seed:** 43939
- **rationale:** card_id digits → 39, formula 40000 + 101 × 39
...
- **output_path:** `art/iron_penitents/p39_reliquary_of_wounds.png`
- **iterations_path:** `art_iterations/P39_reliquary_of_wounds/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed43939_v1 | first pass — accept / iterate |
