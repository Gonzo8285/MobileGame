# Per-card art spec — Hemorrhage-Saint
...
```
gaunt saint in shredded white robes, orbiting halo of blood droplets suspended in air,
chest open as wound-gift, drawing rust-red light from self-bleeding
```
...
- **seed:** 41616
- **rationale:** card_id digits → 16, formula 40000 + 101 × 16
...
- **output_path:** `art/iron_penitents/p16_hemorrhage_saint.png`
- **iterations_path:** `art_iterations/P16_hemorrhage_saint/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed41616_v1 | first pass — accept / iterate |
