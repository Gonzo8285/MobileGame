# Per-card art spec — Confession Booth
...
```
dark confessional booth door ajar, iron manacles springing from the frame to snare an entrant,
candlelit interior, curse-roots binding the floor, no escape implied
```
...
- **seed:** 43838
- **rationale:** card_id digits → 38, formula 40000 + 101 × 38
...
- **output_path:** `art/iron_penitents/p38_confession_booth.png`
- **iterations_path:** `art_iterations/P38_confession_booth/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed43838_v1 | first pass — accept / iterate |
