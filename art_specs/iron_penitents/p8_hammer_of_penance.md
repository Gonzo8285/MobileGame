# Per-card art spec — Hammer of Penance
...
- **card_id:** P8
- **display_name:** Hammer of Penance
...
```
war-hammer descending in slow ceremonial arc, brass helm of target below,
impact dust and bleed-light rising, judge-executioner stance, heavy chains across the haft
```
...
- **seed:** 40808
- **rationale:** card_id digits → 8, formula 40000 + 101 × 8
...
- **output_path:** `art/iron_penitents/p8_hammer_of_penance.png`
- **iterations_path:** `art_iterations/P8_hammer_of_penance/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed40808_v1 | first pass — accept / iterate |
