# Per-card art spec — Sin-Eater Novice
...
```
novice mid-consumption of sacrifice-flame, mouth agape as smoke pours into throat,
absorbing fallen ally's strength, iron collar at neck, eyes rolling white
```
...
- **seed:** 42222
- **rationale:** card_id digits → 22, formula 40000 + 101 × 22
...
- **output_path:** `art/iron_penitents/p22_sin_eater_novice.png`
- **iterations_path:** `art_iterations/P22_sin_eater_novice/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed42222_v1 | first pass — accept / iterate |
