# Per-card art spec — Open-Veined Pilgrim
...
- **card_id:** P10
- **display_name:** Open-Veined Pilgrim
...
```
tattered pilgrim holding open forearm wounds like offerings to the air,
wild eyes above the mask, stepping forward in final act of willing sacrifice
```
...
- **seed:** 41010
- **rationale:** card_id digits → 10, formula 40000 + 101 × 10
...
- **output_path:** `art/iron_penitents/p10_open_veined_pilgrim.png`
- **iterations_path:** `art_iterations/P10_open_veined_pilgrim/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed41010_v1 | first pass — accept / iterate |
