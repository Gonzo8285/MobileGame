# Per-card art spec — Penitent Acolyte
...
```
young acolyte in oversized grey habit, clutching mortification-bead necklace,
simple cloth mask, wide eyes still learning yet defiant, untested but devoted
```
...
- **seed:** 42121
- **rationale:** card_id digits → 21, formula 40000 + 101 × 21
...
- **output_path:** `art/iron_penitents/p21_penitent_acolyte.png`
- **iterations_path:** `art_iterations/P21_penitent_acolyte/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed42121_v1 | first pass — accept / iterate |
