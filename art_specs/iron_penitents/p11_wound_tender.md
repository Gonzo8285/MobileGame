# Per-card art spec — Wound-Tender
...
```
grey-cloaked field medic pressing both hands to a comrade's wound,
iron forceps at belt, clinical focus through execution-mask, blood-soaked sleeves
```
...
- **seed:** 41111
- **rationale:** card_id digits → 11, formula 40000 + 101 × 11
...
- **output_path:** `art/iron_penitents/p11_wound_tender.png`
- **iterations_path:** `art_iterations/P11_wound_tender/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed41111_v1 | first pass — accept / iterate |
