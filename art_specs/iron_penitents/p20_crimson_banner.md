# Per-card art spec — Crimson Banner
...
```
furled crimson-black faction banner planted in rubble, unseen iron stake beneath,
thread-thin curse-fire glowing along the edges, waiting like a sprung trap
```
...
- **seed:** 42020
- **rationale:** card_id digits → 20, formula 40000 + 101 × 20
...
- **output_path:** `art/iron_penitents/p20_crimson_banner.png`
- **iterations_path:** `art_iterations/P20_crimson_banner/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed42020_v1 | first pass — accept / iterate |
