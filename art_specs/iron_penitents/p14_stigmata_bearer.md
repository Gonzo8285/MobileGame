# Per-card art spec — Stigmata-Bearer
...
```
robed penitent kneeling with both palms extended, seeping wounds at stigmata-points
glowing rust-red, living curse-source, white eyes rolled back in devotion
```
...
- **seed:** 41414
- **rationale:** card_id digits → 14, formula 40000 + 101 × 14
...
- **output_path:** `art/iron_penitents/p14_stigmata_bearer.png`
- **iterations_path:** `art_iterations/P14_stigmata_bearer/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed41414_v1 | first pass — accept / iterate |
