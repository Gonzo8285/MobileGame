# Per-card art spec — Hammer-Confessor
...
```
broad-shouldered penitent cleric gripping two-handed war-hammer,
brass execution-mask covering lower face, grey habit torn at chest, melee authority
```
...
- **seed:** 40404
- **rationale:** card_id digits → 4, formula 40000 + 101 × 4
...
- **output_path:** `art/iron_penitents/p4_hammer_confessor.png`
- **iterations_path:** `art_iterations/P4_hammer_confessor/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed40404_v1 | first pass — accept / iterate |
