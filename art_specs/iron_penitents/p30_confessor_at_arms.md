# Per-card art spec — Confessor-At-Arms
...
- **card_id:** P30
- **display_name:** Confessor-At-Arms
...
```
battle-confessor in full plate engraved with catechism text, two-handed reach-hammer at guard,
directing the close-quarters melee, iron-mask polished to a mirror-finish
```
...
- **seed:** 43030
- **rationale:** card_id digits → 30, formula 40000 + 101 × 30
...
- **output_path:** `art/iron_penitents/p30_confessor_at_arms.png`
- **iterations_path:** `art_iterations/P30_confessor_at_arms/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed43030_v1 | first pass — accept / iterate |
