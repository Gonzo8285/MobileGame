# Per-card art spec — Pilgrim of the Open Vein
...
- **card_id:** P13
- **display_name:** Pilgrim of the Open Vein
...
```
lean penitent with self-carved sigils glowing rust-red on both forearms,
observing the battlefield with eerie patience, channelling wound-energy into power
```
...
- **seed:** 41313
- **rationale:** card_id digits → 13, formula 40000 + 101 × 13
...
- **output_path:** `art/iron_penitents/p13_pilgrim_of_the_open_vein.png`
- **iterations_path:** `art_iterations/P13_pilgrim_of_the_open_vein/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed41313_v1 | first pass — accept / iterate |
