# Per-card art spec — Iron Vespers
...
```
penitent choir-warrior in full engraved iron plate, one gauntlet raised conducting allies,
other hand gripping war-hammer mid-sweep, authoritative presence, choir-candles guttering
```
...
- **seed:** 43434
- **rationale:** card_id digits → 34, formula 40000 + 101 × 34
...
- **output_path:** `art/iron_penitents/p34_iron_vespers.png`
- **iterations_path:** `art_iterations/P34_iron_vespers/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed43434_v1 | first pass — accept / iterate |
