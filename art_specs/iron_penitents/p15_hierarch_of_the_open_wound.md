# Per-card art spec — Hierarch of the Open Wound
...
- **card_id:** P15
- **display_name:** Hierarch of the Open Wound
...
```
senior hierarch in ornate brass execution-mask and blood-soaked ceremonial robes,
both arms raised mid-sermon, bleeding from every joint in ritual ecstasy
```
...
- **seed:** 41515
- **rationale:** card_id digits → 15, formula 40000 + 101 × 15
...
- **output_path:** `art/iron_penitents/p15_hierarch_of_the_open_wound.png`
- **iterations_path:** `art_iterations/P15_hierarch_of_the_open_wound/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed41515_v1 | first pass — accept / iterate |
