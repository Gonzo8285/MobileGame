# Per-card art spec — Headsman of the Long Aisle
...
- **card_id:** P33
- **display_name:** Headsman of the Long Aisle
...
```
legendary executioner striding the full cathedral aisle, massive cleaver raised horizontally,
every enemy in the row scattered, iron-shrine towering behind them
```
...
- **seed:** 43333
- **rationale:** card_id digits → 33, formula 40000 + 101 × 33
...
- **output_path:** `art/iron_penitents/p33_headsman_of_the_long_aisle.png`
- **iterations_path:** `art_iterations/P33_headsman_of_the_long_aisle/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed43333_v1 | first pass — accept / iterate |
