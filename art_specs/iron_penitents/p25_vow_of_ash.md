...
```
penitent's body dissolving from feet upward into column of pale ash, arms raised in offering,
two glowing cards materialising from the smoke as the vow is sealed
```
...
- **seed:** 42525
- **rationale:** card_id digits → 25, formula 40000 + 101 × 25
...
- **output_path:** `art/iron_penitents/p25_vow_of_ash.png`
- **iterations_path:** `art_iterations/P25_vow_of_ash/`
- **alt_arts:** []
- **idle_loop_frames:** 2
