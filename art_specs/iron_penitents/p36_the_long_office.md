# Per-card art spec — The Long Office
...
```
cathedral ruin floor split by a single slash of divine-light impact in a three-tile line,
hooded caster barely visible at far edge, rubble thrown, silence after the blow
```
...
- **seed:** 43636
- **rationale:** card_id digits → 36, formula 40000 + 101 × 36
...
- **output_path:** `art/iron_penitents/p36_the_long_office.png`
- **iterations_path:** `art_iterations/P36_the_long_office/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed43636_v1 | first pass — accept / iterate |
