# Per-card art spec — Lash-Master Galor
...
- **card_id:** P24
- **display_name:** Lash-Master Galor
...
```
scarred penitent officer with brutal iron lash at hip, watching battlefield
with tactical predator's eye, reacting to every ally's fall with cold executioner's calm
```
...
- **seed:** 42424
- **rationale:** card_id digits → 24, formula 40000 + 101 × 24
...
- **output_path:** `art/iron_penitents/p24_lash_master_galor.png`
- **iterations_path:** `art_iterations/P24_lash_master_galor/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed42424_v1 | first pass — accept / iterate |
