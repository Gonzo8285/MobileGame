# Per-card art spec — Nail-Choir Flagellant
...
- **card_id:** P1
- **display_name:** Nail-Choir Flagellant
...
```
gaunt penitent in torn grey habit, iron nails hammered into own back,
chanting in processional, blood-streaked robes, hollow zealot's eyes above the cloth mask
```
...
- **seed:** 40101
- **rationale:** card_id digits → 1, formula 40000 + 101 × 1
...
- **output_path:** `art/iron_penitents/p1_nail_choir_flagellant.png`
- **iterations_path:** `art_iterations/P1_nail_choir_flagellant/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed40101_v1 | first pass — accept / iterate |
