# Per-card art spec — Crowned Martyr
...
```
penitent bound in iron-thorned crown, blood on brow, chains wrapped at wrists,
kneeling yet defiant, accepting punishment as act of devotion
```
...
- **seed:** 40303
- **rationale:** card_id digits → 3, formula 40000 + 101 × 3
...
- **output_path:** `art/iron_penitents/p3_crowned_martyr.png`
- **iterations_path:** `art_iterations/P3_crowned_martyr/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed40303_v1 | first pass — accept / iterate |
