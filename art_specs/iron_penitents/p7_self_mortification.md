# Per-card art spec — Self-Mortification
...
- **card_id:** P7
- **display_name:** Self-Mortification
...
```
penitent willingly pressing a long iron nail through palm, divine rust-red light
pouring from wound, solo ritual, ash floor, single candle lighting the scene
```
...
- **seed:** 40707
- **rationale:** card_id digits → 7, formula 40000 + 101 × 7
...
- **output_path:** `art/iron_penitents/p7_self_mortification.png`
- **iterations_path:** `art_iterations/P7_self_mortification/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed40707_v1 | first pass — accept / iterate |
