# Per-card art spec — Hooded Headsman
...
```
tall executioner in ceremonial hood, great-axe resting on shoulder,
eyes glinting through hood-slits at a fresh kill below, unhurried and methodical
```
...
- **seed:** 43232
- **rationale:** card_id digits → 32, formula 40000 + 101 × 32
...
- **output_path:** `art/iron_penitents/p32_hooded_headsman.png`
- **iterations_path:** `art_iterations/P32_hooded_headsman/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed43232_v1 | first pass — accept / iterate |
