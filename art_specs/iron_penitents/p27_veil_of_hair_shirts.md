# Per-card art spec — Veil of Hair-Shirts
...
- **card_id:** P27
- **display_name:** Veil of Hair-Shirts
...
```
coarse hair-shirt cloth cascading from a doorframe like a curse-curtain,
iron briars woven through the hem, penitent-sigils stitched along every border, trap-rune below
```
...
- **seed:** 42727
- **rationale:** card_id digits → 27, formula 40000 + 101 × 27
...
- **output_path:** `art/iron_penitents/p27_veil_of_hair_shirts.png`
- **iterations_path:** `art_iterations/P27_veil_of_hair_shirts/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed42727_v1 | first pass — accept / iterate |
