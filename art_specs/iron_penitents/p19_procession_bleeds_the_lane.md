# Per-card art spec — Procession Bleeds the Lane
...
- **card_id:** P19
- **display_name:** Procession Bleeds the Lane
...
```
cathedral aisle flooding with converging streams of blood from a hundred penitent wounds,
crimson tide rushing toward the viewer, lit from below in rust-red
```
...
- **seed:** 41919
- **rationale:** card_id digits → 19, formula 40000 + 101 × 19
...
- **output_path:** `art/iron_penitents/p19_procession_bleeds_the_lane.png`
- **iterations_path:** `art_iterations/P19_procession_bleeds_the_lane/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed41919_v1 | first pass — accept / iterate |
