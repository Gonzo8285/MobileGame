# Per-card art spec — Whip-Brother
...
```
hunched penitent swinging a heavy iron-link flail, cropped hood, scarred bare forearms,
grimacing mid-swing, spiked chain scoring own wrist in the arc
```
...
- **seed:** 40202
- **rationale:** card_id digits → 2, formula 40000 + 101 × 2
...
- **output_path:** `art/iron_penitents/p2_whip_brother.png`
- **iterations_path:** `art_iterations/P2_whip_brother/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed40202_v1 | first pass — accept / iterate |
