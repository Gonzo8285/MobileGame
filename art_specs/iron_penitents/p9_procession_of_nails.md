# Per-card art spec — Procession of Nails
...
- **card_id:** P9
- **display_name:** Procession of Nails
...
```
processional column of hooded penitents through ruined cathedral,
each bearing a nail-studded club raised in unison, ash raining from vaulted ceiling
```
...
- **seed:** 40909
- **rationale:** card_id digits → 9, formula 40000 + 101 × 9
...
- **output_path:** `art/iron_penitents/p9_procession_of_nails.png`
- **iterations_path:** `art_iterations/P9_procession_of_nails/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed40909_v1 | first pass — accept / iterate |
