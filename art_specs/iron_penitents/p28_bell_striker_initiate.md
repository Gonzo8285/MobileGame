# Per-card art spec — Bell-Striker Initiate
...
- **card_id:** P28
- **display_name:** Bell-Striker Initiate
...
```
young penitent swinging a heavy brass hand-bell as weapon in first battle,
determined eyes above plain initiate's mask, lanyard wrapped tight around the wrist
```
...
- **seed:** 42828
- **rationale:** card_id digits → 28, formula 40000 + 101 × 28
...
- **output_path:** `art/iron_penitents/p28_bell_striker_initiate.png`
- **iterations_path:** `art_iterations/P28_bell_striker_initiate/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed42828_v1 | first pass — accept / iterate |
