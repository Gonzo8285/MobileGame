# Per-card art spec — The Crucified Saint
...
- **card_id:** P6
- **display_name:** The Crucified Saint
...
```
emaciated saint spread-eagled mid-air in self-crucifixion, rune-burned chest,
mouth open in ecstatic pain, cracked iron halo, stigmata bleeding freely
```
...
- **seed:** 40606
- **rationale:** card_id digits → 6, formula 40000 + 101 × 6
...
- **output_path:** `art/iron_penitents/p6_the_crucified_saint.png`
- **iterations_path:** `art_iterations/P6_the_crucified_saint/`
- **alt_arts:** []
- **idle_loop_frames:** 2
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed40606_v1 | first pass — accept / iterate |
