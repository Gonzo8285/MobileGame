# Per-card art spec — Tree-Walker Mhar
...
- **seed:** 54242
- **rationale:** Warlord #5, formula `warlord_number × 10000 + 4242` (per `_template.md` Warlord rule). Sits clear of all five faction common-card seed ranges.
...
- **output_path:** `art/warlords/w5_tree_walker_mhar.png`
- **iterations_path:** `art_iterations/W5_tree_walker_mhar/`
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed54242_v1 | first pass — accept / iterate |
