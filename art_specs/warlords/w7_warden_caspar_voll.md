# Per-card art spec — Warden Caspar Voll, the Empty Throne
...
- **card_id:** W7
- **display_name:** Warden Caspar Voll, the Empty Throne
- **faction:** last_legion
- **card_type:** WARLORD
- **rarity:** LEGENDARY
...
```
Last Legion warden who jailed his own emperor for cowardice during the
march on Gallowfell, keyring of human teeth, faded Ferrum sash,
broken sceptre as cudgel, missing one ear, faceless beneath the helm
```
...
- **seed:** 74242
- **rationale:** Warlord #7, formula `warlord_number × 10000 + 4242` (per `_template.md` Warlord rule). Sits clear of all five faction common-card seed ranges.
...
- **output_path:** `art/warlords/w7_warden_caspar_voll.png`
- **iterations_path:** `art_iterations/W7_warden_caspar_voll/`
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed74242_v1 | first pass — accept / iterate |
