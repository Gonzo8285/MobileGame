# Per-card art spec — Court-Necromant Sieren
...
- **card_id:** W2
- **display_name:** Court-Necromant Sieren
...
- **seed:** 24242
- **rationale:** Warlord #2, formula `warlord_number × 10000 + 4242` (per `_template.md` Warlord rule). Sits clear of all five faction common-card seed ranges.
...
- **output_path:** `art/warlords/w2_court_necromant_sieren.png`
- **iterations_path:** `art_iterations/W2_court_necromant_sieren/`
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed24242_v1 | first pass — accept / iterate |
