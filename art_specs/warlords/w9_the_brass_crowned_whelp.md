# Per-card art spec — The Brass-Crowned Whelp
...
- **card_id:** W9
- **display_name:** The Brass-Crowned Whelp
...
```
Cinderwood child who melted a cathedral bell and crowned himself with it,
small figure in oversized brass crown, leashed pack of stitched hounds,
tear-streaked, barefoot, the hounds came when he wept
```
...
- **loras:**
  ...
  - `Mythical Forest Style [SDXL]` v1.0 @ 0.5   ← Skinward Pact faction LoRA, trigger ral-mytfrst
...
> **Deviation note:** Hybrid Skinward Pact × Iron Penitents — primary = Skinward Pact (Cinderwood
origin + beast pack). Brass-crown / cathedral-bell motifs layered via subject
text. Same dual-LoRA escalation rule as W6 if needed.
...
- **seed:** 94242
- **rationale:** Warlord #9, formula `warlord_number × 10000 + 4242` (per `_template.md` Warlord rule). Sits clear of all five faction common-card seed ranges.
...
- **output_path:** `art/warlords/w9_the_brass_crowned_whelp.png`
- **iterations_path:** `art_iterations/W9_the_brass_crowned_whelp/`
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed94242_v1 | first pass — accept / iterate |
...
- [ ] Body-horror tolerance — druidic-with-phyrexian-undertones present, no explicit gore
