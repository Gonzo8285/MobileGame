# Per-card art spec — The Saint of Gallowsmoke
...
- **card_id:** W8
- **display_name:** The Saint of Gallowsmoke
- **faction:** coven
- **card_type:** WARLORD
- **rarity:** LEGENDARY
...
```
Bog child accidentally canonised by the Court when smoke was mistaken
for a sign, tall thin saint-figure, halo of greenish smoke, trailing
censer chains, no visible feet, the smoke listens to her now
```
...
> **Deviation note:** Hybrid Coven × Ash-Mourners — primary = Coven (her Bog origin + green-pyre
smoke colour). Court-canonisation iconography (halo, censer chains) layered
via subject text. Same dual-LoRA escalation rule as W6 if needed.
...
- **seed:** 84242
- **rationale:** Warlord #8, formula `warlord_number × 10000 + 4242` (per `_template.md` Warlord rule). Sits clear of all five faction common-card seed ranges.
...
- **output_path:** `art/warlords/w8_the_saint_of_gallowsmoke.png`
- **iterations_path:** `art_iterations/W8_the_saint_of_gallowsmoke/`
...
| Date | Iteration | Note |
|---|---|---|
| 2026-05-XX | seed84242_v1 | first pass — accept / iterate |
